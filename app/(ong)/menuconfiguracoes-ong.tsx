    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        ...
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
          ...
          <TouchableOpacity style={styles.item} onPress={() => (router as any).push('/(ong)/endereco')}>
          ...
          <TouchableOpacity style={styles.item} onPress={() => (router as any).push('/(ong)/privacidade')}>
