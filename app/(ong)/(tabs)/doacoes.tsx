...
import { View, Text, StyleSheet, TouchableOpacity, ScrollView, StatusBar,Image,ImageBackground,Dimensions,TextInput,Modal,Alert,Platform,         ActivityIndicator  } from 'react-native';
